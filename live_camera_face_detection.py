...
face_cascade = cv2.CascadeClassifier(r"C:\FSDS\NIT\spacy\Harcascades\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"C:\FSDS\NIT\spacy\Harcascades\haarcascade_eye.xml")
